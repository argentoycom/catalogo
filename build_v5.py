...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* Marquesina Superior Equilibrada */
  .marquee {
    background: #16141e;
    color: #ffd23f;
    font-weight: 700;
  ...
  /* Contenedor de foto con MARCA DE AGUA EN ESQUINA SUPERIOR DE CARTÓN (top: 22%, left: 15%) */
  .card .ph {
    position: relative;
    aspect-ratio: 1/1;
    background: #ffffff;
  ...
  /* Marca de agua visual en tarjetas (.ph::after) - top: 22%, left: 15%, rotate -12deg */
  .card .ph::after {
  ...
  /* Contenedor de foto ampliada con MARCA DE AGUA (top: 22%, left: 15%) */
  .lb__img {
    position: relative;
    background: #ffffff;
    border-radius: 12px;
  ...
  /* Marca de agua visual en visor Lightbox (.lb__img::after) - top: 22%, left: 15%, rotate -12deg */
  .lb__img::after {
    content: "ARGENTOY GLOBAL";
    position: absolute;
    top: 22%;
...
<body>
  ...
  <div class="marquee" aria-hidden="true">
    <div class="marquee__track">
      <span>ENVÍOS A TODO EL MUNDO</span><span>DESCUENTOS POR CANTIDAD</span><span>WORLDWIDE SHIPPING</span><span>BULK DISCOUNTS</span><span>CHECK STOCK VIA WHATSAPP</span><span>ENVÍOS A TODO EL MUNDO</span><span>DESCUENTOS POR CANTIDAD</span><span>WORLDWIDE SHIPPING</span><span>BULK DISCOUNTS</span><span>CHECK STOCK VIA WHATSAPP</span>
    </div>
  </div>
...
/* =========================================================
   📦 CATÁLOGO - POP CULTURE & MEMES CON EMOJI RAYO (⚡) EN ÍNDICE 0
   ========================================================= */
const CATS = [
...
/* =========================================================
   🎨 RENDER (activeCat = 0 seleccionado por defecto)
   ========================================================= */
...
let activeCat = 0; // Pop Culture & Memes seleccionada por defecto en el primer lugar
let searchQuery = "";
...
function waLink(){
  ...
  const outroPart = WA_OUTRO ? `%0A${encodeURIComponent(WA_OUTRO)}` : '';
  const msg = `${encodeURIComponent(WA_INTRO)}%0A${lista}%0A%0ATotal: ${n} ${itemTxt}.${outroPart}`;
...
print("v5 fixed script compiled cleanly!")
