...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* Contenedor de foto con MARCA DE AGUA EN ESQUINA SUPERIOR IZQUIERDA */
  .card .ph {
    position: relative;
    aspect-ratio: 1/1;
    background: #ffffff;
  ...
  /* Marca de agua visual en tarjetas (.ph::after) - Esquina superior izquierda (-12deg) */
  .card .ph::after {
  ...
  /* Contenedor de foto ampliada con MARCA DE AGUA EN ESQUINA SUPERIOR IZQUIERDA */
  .lb__img {
    position: relative;
    background: #ffffff;
    border-radius: 12px;
  ...
  /* Marca de agua visual en visor Lightbox (.lb__img::after) - Esquina superior izquierda (-12deg) */
  .lb__img::after {
    content: "ARGENTOY GLOBAL";
    position: absolute;
    top: 8%;
...
function renderDrawer(){
  ...
  selected.forEach(code=>{
    ...
    const row = document.className = "drow";
    row.innerHTML = `
...
print("v4 script compiled cleanly!")
