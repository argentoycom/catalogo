...
<title>100% MILONGA by Argentoy International · Official Catalog</title>
<meta name="description" content="Adult collectibles. Not toys. Official bootleg custom figures catalog. Tap + to check stock via WhatsApp.">
...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .top-ribbon__track span { padding: 0 20px; }
  .top-ribbon__track span::after { content: "✦"; padding-left: 40px; color: var(--text-muted); }
  ...
  /* Permanently Visible Floating WhatsApp Bar & Widget */
  .bar {
    position: fixed;
    left: 50%;
...
function renderGrid(){
  ...
  if (searchQuery.trim()) {
    ...
    // Requerimiento #8: En el buscador dejar SOLAMENTE la opción de buscar por nombre (NO buscar por código)
...
function updateBar(){
  ...
  // Barra flotante siempre visible o al seleccionar
...
print("Catalogs successfully rebuilt with all 12 custom design and data requests!")
